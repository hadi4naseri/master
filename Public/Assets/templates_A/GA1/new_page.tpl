...
function insert_page()
{
   if (document.getElementById('site_title').value=="" || CKEDITOR.instances.editor11.getData()=="")
	...
	else
	{
	  ...
	  xmlhttp.open("post","new_page_db.php",true);
	  xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	  xmlhttp.send("title="+document.getElementById('site_title').value+"&content="+encodeURIComponent(CKEDITOR.instances.editor11.getData()));
...
عنوان نمایشی صفحه :
<input type="text" width="80" id="site_title" size="50"/><br/><br/>
درج متن صفحه و یا کد HTML :
<textarea id="editor11" class="ckeditor" cols="80" name="editor1" rows="10"></textarea><br/>
</div>

<p><input onclick="insert_page();" type="button" value="درج صفحه جدید" /> </p>
