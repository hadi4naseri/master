...
<link rel="shortcut icon" href="{$urlPatch}/images/favicon.ico"  type="image/x-icon">

<!-- CSS-->
<!-- Google web fonts. You can get your own bundle at http://www.google.com/fonts. Don't forget to update the CSS accordingly!-->
<link href='http://fonts.googleapis.com/css?family=Droid+Serif|Ubuntu' rel='stylesheet' type='text/css'>

<link rel="stylesheet" href="{$urlPatch}/css/normalize.css">
<link rel="stylesheet" href="{$urlPatch}/js/flexslider/flexslider.css">
<link rel="stylesheet" href="{$urlPatch}/css/basic-style.css">

<!-- end CSS-->
    
<!-- JS-->
<script src="{$urlPatch}/js/libs/modernizr-2.6.2.min.js"></script>
<!-- end JS-->
...
<!-- header area -->
    <header class="wrapper clearfix">
        ...
        <div id="banner">        
        	<div id="logo"><a href="basic.html"><img src="{$urlPatch}/images/basic-logo.svg" alt="logo"></a></div> 
        </div>
	...
	<section id="content" class="wide-content">
      <div class="row">	
        ...
        <div class="grid_4">
            ...
            <img src="{$urlPatch}/images/basic-pic2.jpg" />
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        </div>
...
<script defer src="{$urlPatch}/js/flexslider/jquery.flexslider-min.js"></script>

<!-- fire ups - read this file!  -->   
<script src="{$urlPatch}/js/main.js"></script>
