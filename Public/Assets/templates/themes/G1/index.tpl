...
<link href="{$urlPatch}/default.css" rel="stylesheet" type="text/css" media="all" />
<link href="{$urlPatch}/fonts.css" rel="stylesheet" type="text/css" media="all" />

<!--[if IE 6]><link href="{$urlPatch}/default_ie6.css" rel="stylesheet" type="text/css" /><![endif]-->
...
<div id="welcome">
	<div class="container">
        ...
        <img src="{$urlPatch}/images/pic02.jpg" alt="" class="image image-full" />
