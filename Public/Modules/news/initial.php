...
function news_initial(&$smartyObj=null,$handle)
{
...
//loading data....
$itemData=select($tenant,"news",array("languages"=>1,"data"=>1,"addons"=>1),array("handle"=>$handle));
...
return array("schema"=>$itemSchema,"template"=>$template,"content"=>$itemData["data"],"addons"=>$addonsData,"handle"=>$handle,"moduleName"=>"news");	
