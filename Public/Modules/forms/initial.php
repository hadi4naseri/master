...
function forms_initial(&$smartyObj)
{
...
$raw_data=json_decode(select($tenant,"modules",array(),array("name"=>"forms")),true)[0];
...
$raw_data2=json_decode(select($tenant,"forms",array(),array(),0),true);
...
$raw_data=json_decode(select($tenant,"modules",array(),array("name"=>"forms")),true);
...
//------------------------------------------------------------
$raw_data2=json_decode(select($tenant,"forms",array(),array("id"=>$id),0),true);
